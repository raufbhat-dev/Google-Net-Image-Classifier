...
print("training data",tf.data.experimental.cardinality(train_ds).numpy())
print("validation data",tf.data.experimental.cardinality(val_ds).numpy())
print("test data",tf.data.experimental.cardinality(test_ds).numpy())
